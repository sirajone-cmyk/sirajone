...
export default function WhatsAppButton({
  ...
  const variants = {
    primary: 'bg-[#22c55e] text-white hover:bg-[#16a34a] shadow-md shadow-green-900/25',
    outline: 'border border-[#22c55e]/40 bg-[#22c55e]/8 text-[#4ade80] hover:bg-[#22c55e]/15',
    ghost:   'text-[#4ade80] hover:bg-[#22c55e]/10',
  };
  ...
  return (
    ...
    >
      <WhatsAppIcon size={size === 'sm' ? 13 : 16} />
      {label}
    </a>
  );
}
