      ...
      <div className="max-w-4xl mx-auto px-4 pb-20 space-y-6">
        <div className="grid sm:grid-cols-2 gap-5">
          {[
            ...
            { icon: Mail, label: 'Email', val: 'madrasatahseenuquran@gmail.com', link: 'mailto:madrasatahseenuquran@gmail.com' },
            { icon: Globe, label: 'Website', val: 'tahseenulquraan.org', link: 'https://tahseenulquraan.org' },
          ].map(c => (
        ...
        <div className="bg-emerald-950/60 border border-emerald-900 rounded-3xl p-8 text-center">
          ...
          <a href="mailto:madrasatahseenuquran@gmail.com?subject=Enrolment Enquiry"
        ...
        <div className="bg-white/5 border border-white/10 rounded-3xl p-6 flex flex-col sm:flex-row gap-5 items-start">
          ...
          <div>
            ...
            <p className="text-emerald-400 text-sm mb-3">Founder & Lead Teacher · Madrassatu Taḥsīnil Qur'ān</p>
