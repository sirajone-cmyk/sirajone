...
export const SUBJECTS_DATA = [
  ...
  { id: 'cupping', title: "Cupping Course", arabic: "الحجامة", desc: "Learn the Sunnah practice of Ḥijāmah (cupping). Theory and practical training.", price: { group: 400, private: 700 }, level: "All Levels", badge: "bg-red-900 text-red-300", color: "border-red-800 bg-red-950/20", teacherIds: [], comingSoon: true },
];
